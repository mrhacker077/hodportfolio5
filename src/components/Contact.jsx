          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-lg">+91 9741127644</p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
              <div className="bg-blue-500 p-3 rounded-full">
              ...
              <div>
                ...
                <p className="text-lg">devarajukpt@gmail.com</p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
              <div className="bg-blue-500 p-3 rounded-full">
              ...
              <div>
                ...
                <p className="text-lg">Vyasanagar, KPT, Mangalore.</p>
              </div>
            </div>
          </div>
          <div className="mt-6 flex space-x-4">
            <a href="https://www.facebook.com/devaraju.d.9047" className="text-blue-500 text-4xl">
              <i className="fab fa-facebook"></i>
            </a>
            <div>
            <p className="text-sm text-gray-400">FACEBOOK</p>
            <p className="text-lg">Devraju.D</p>
            </div>
          </div>
        </div>
